...
const OPTION_DESCRIPTION_KEYS = {
  ...
  'doctor|--recovery-plan': 'help.option.doctor.recoveryPlan',
  'doctor|--mcp-config': 'help.option.doctor.mcpConfig',
  'doctor|--registry': 'help.option.doctor.registry',
  'doctor|--json': 'help.option.doctor.json',
  'doctor|--show-paths': 'help.option.doctor.showPaths',

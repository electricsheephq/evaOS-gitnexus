...
const OPTION_DESCRIPTION_KEYS = {
  ...
  'analyze|--skip-ai-context': 'help.option.analyze.skipAiContext',
  'analyze|--default-branch <branch>': 'help.option.analyze.defaultBranch',
  ...
  'analyze|--embedding-base-url <url>': 'help.option.analyze.embeddingBaseUrl',
  'analyze|--embedding-model <model>': 'help.option.analyze.embeddingModel',
  'analyze|--embedding-auth-token <token>': 'help.option.analyze.embeddingAuthToken',
  'analyze|--embedding-dims <n>': 'help.option.analyze.embeddingDims',
  ...
  'query|--max-tokens <n>': 'help.option.maxTokens',
  ...
  'context|--max-tokens <n>': 'help.option.maxTokens',

...
export const zhCN = {
  ...
  'help.option.doctor.mcpConfig': '在不绑定服务或打开索引的情况下验证 MCP 仓库策略',
  'help.option.doctor.registry': '检查注册表标识、元数据、侧车文件和数据库计数',
  'help.option.doctor.json': '输出机器可读结果（仅限 --mcp-config 或 --registry）',
  'help.option.doctor.showPaths': '显示注册表中的绝对路径（仅限 --registry）',
